export const settingsZhCN = {
  settings: {
    ...
    classProfiles: '班级成员',
    classProfilesDesc: '添加自定义学生角色，将在课堂中作为AI同学参与讨论',
    addStudent: '添加学生',
    studentName: '姓名',
    studentPersonality: '性格特点（可选）',
    autoAgentCount: '生成数量',
  ...
  profile: {
    ...
    backgroundPlaceholder: '你的专业/教育背景（如：计算机大三、市场营销经理）',
    careerPlaceholder: '你的职业目标（如：成为数据科学家、转型产品管理）',
...
export const settingsEnUS = {
  settings: {
    ...
    classProfiles: 'Class Members',
    classProfilesDesc: 'Add custom student profiles that will participate as AI classmates',
    addStudent: 'Add Student',
    studentName: 'Name',
    studentPersonality: 'Personality (optional)',
  ...
  profile: {
    ...
    backgroundPlaceholder: 'Your professional/educational background (e.g., 3rd year CS student, marketing manager)',
    careerPlaceholder: 'Your career aspiration (e.g., become a data scientist, transition to product management)',
